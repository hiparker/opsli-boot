...
public interface GenTemplateRestApi {
    ...
    */
    @GetMapping("/get")
    ResultWrapper<GenTemplateModel> get(GenTemplateModel model);
    ...
    */
    @PostMapping("/insert")
    ResultWrapper<?> insert(@RequestBody GenTemplateModel model);
    ...
    ResultWrapper<?> insertAndDetail(@RequestBody GenTemplateAndDetailModel model);
    ...
    */
    @PostMapping("/update")
    ResultWrapper<?> update(@RequestBody GenTemplateModel model);
    ...
    ResultWrapper<?> updateAndDetail(@RequestBody GenTemplateAndDetailModel model);
     ...
     */
    @PostMapping("/copy")
    ResultWrapper<?> copy(@RequestBody GenTemplateCopyModel model);
